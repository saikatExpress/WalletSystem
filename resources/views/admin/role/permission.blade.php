                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    @foreach ($permissions as $key => $permission)
                                        <tr class="list-item">
                                            ...
                                            <td>
                                                <a href="{{ route('role.edit' , ['id' => $permission->id]) }}" class="btn btn-sm btn-primary">Edit</a>
                                                <button class="btn btn-sm btn-danger deleteButton" data-id={{ $permission->id }}><i class="fas fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        @php
                                            $sl++;
