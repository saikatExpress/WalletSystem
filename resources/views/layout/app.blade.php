        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <div class="form-inline mr-auto">
                    ...
                    <div>
                        <form action="{{ route('language') }}" id="languageForm" method="post">
                            @csrf
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="profile.html" class="dropdown-item has-icon"> <i
                                ...
                                Activities
                            </a> <a href="{{ route('setting.store') }}" class="dropdown-item has-icon"> <i
                                    class="fas fa-cog"></i>
                                {{ __('messages.setting') }}
                            </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown">
                                <i data-feather="briefcase"></i><span>{{ __('messages.user') }}</span>
                            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link"
                                        href="{{ route('permission.list') }}">{{ __('messages.permission') }}</a>
                                </li>
                            </ul>
                        </li>
